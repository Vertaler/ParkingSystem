...
// configuration step. It creates a namespace called `ParkingSystem`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ParkingSystem::cmake::project_name, ParkingSystem::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", ParkingSystem::cmake::project_version);
      return EXIT_SUCCESS;
    }
